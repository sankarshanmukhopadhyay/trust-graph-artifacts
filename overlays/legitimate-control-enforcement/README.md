# Legitimate Control Enforcement Overlay

**Kind:** overlay  
**Path:** `overlays/legitimate-control-enforcement`  
**Source essay:** Enforceable Authority Without Legitimate Control  
**Published:** 2026-04-08

## Why this package exists

This package operationalizes the essay’s core asymmetry. It defines the control-side requirements that must exist if a system is going to claim legitimate control rather than merely enforceable authority.
