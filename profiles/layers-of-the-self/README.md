...
**Kind:** profile  
**Path:** `profiles/layers-of-the-self`  
**Source essay:** Layers of the Self  
**Published:** 2026-01-12  
**Signal tier:** A (20.0% engagement)
...
A profile captures a reusable trust-system configuration with bounded roles, controls, decisions, and evidence expectations.
...
- **Graph identifier:** `ttg.profile.layers-of-the-self`
- **Node count:** 14
- **Edge count:** 14
...
- Essay URL: `pending-external-link`
