# TSMM Mapping: wallet-to-agent-identity

## Binding summary

This artifact now has a machine-readable TSMM projection at:

- `bindings/tsmm/projections/wallet-to-agent-identity.yaml`
...
- Manifest: `artifacts/wallet-to-agent-identity/artifact.yaml`
- Artifact schema: `artifacts/wallet-to-agent-identity/schemas/wallet-agent-binding-contract.yaml`
- TSMM projection: `bindings/tsmm/projections/wallet-to-agent-identity.yaml`
