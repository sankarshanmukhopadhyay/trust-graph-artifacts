...
This artifact now includes a TSMM projection at `bindings/tsmm/projections/execution-time-delegation.yaml`. The binding externalizes entities, relationships, controls, evidence, trust decisions, effects, and lifecycle semantics so the artifact can be compared as part of a wider trust-system model.
