# Authority Legitimacy Validation Pattern

**Kind:** pattern  
**Path:** `patterns/authority-legitimacy-validation`  
**Source essay:** Enforceable Authority Without Legitimate Control  
**Published:** 2026-04-08

## Why this package exists

This package turns the essay into a reusable validation pattern. It models the difference between technically enforceable authority and authority that remains legitimate under current policy, issuer status, scope, and revocation state.
