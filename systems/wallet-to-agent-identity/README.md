...
A system package captures an end-to-end operational arrangement with concrete actors, decisions, and effects.
...
- **Graph identifier:** `ttg.system.wallet-to-agent-identity`
- **Node count:** 13
- **Edge count:** 12
